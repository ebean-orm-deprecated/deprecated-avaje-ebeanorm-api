 ...
 * the Encrypt annotation and programmatically via {@link EncryptDeployManager}.
 * </p>
 * 
 * @author rbygrave
 * 
...
public class EncryptDeploy {
     ...
     * @param dbEncrypt set to false if you want to use Java client side encryption rather than DB encryption.
